...
import { modalOverlay, modalPanel, modalPanelReduced, heartBounce, heartBounceReduced } from '../../data/motion'
...
export default function ProductModal({ product, onClose }: ProductModalProps) {
  ...
  useEffect(() => { setActiveImageIndex(0); setJustAdded(false) }, [product?.id])
  ...
  return (
    <AnimatePresence>
      {product && (
        <motion.div id="product-modal-overlay"
          ...
          <motion.div id="product-modal-panel"
